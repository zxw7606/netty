...
public class DefaultChannelPipeline implements ChannelPipeline {
    ...
    @Override
    public final ChannelPipeline flush(ChannelOutboundInvokerCallback callback) {
        tail.flush(callback);
        return this;
    }
    ...
    @Override
    public final ChannelPipeline read(ChannelOutboundInvokerCallback callback) {
        tail.read(callback);
        return this;
    }
    ...
    private static final class HeadHandler implements ChannelHandler {
        ...
        public void read(ChannelHandlerContext ctx, ChannelOutboundInvokerCallback callback) {
            ctx.channel().unsafe().beginRead(callback);
        }
        ...
        public void flush(ChannelHandlerContext ctx, ChannelOutboundInvokerCallback callback) {
            ctx.channel().unsafe().flush(callback);
        }
    }
}
